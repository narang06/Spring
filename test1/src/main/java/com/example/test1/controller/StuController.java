...
public class StuController {
	...
	@ResponseBody
	public String getStudentInfo(Model model, @RequestParam HashMap<String, Object> map) throws Exception {
		HashMap<String, Object> resultMap = new HashMap<String, Object>();
		resultMap = studentService.getStudentInfo(map);
	...
	public String deleteList(Model model, @RequestParam HashMap<String, Object> map) throws Exception {
		...
		resultMap = studentService.getdeleteList(map);
